...
//#define FILE "../data/Record_2017-03-02_09-47-42.h5"
//#define FILE "../data/Record_2017-03-02_10-09-31.h5"
//#define FILE "../data/Record_2017-03-02_10-38-47.h5"
//#define FILE "../data/Record_2017-03-02_10-50-05.h5"
#define FILE "../data/Record_2017-03-02_14-53-24.h5"
...
{ 
    ...
    float sensor_reading[300000][3] = {0};
    ...
    dataset_id = H5Dopen2(file_id, "foc/data_interp", H5P_DEFAULT);
    ...
    for (int i = 10*0; i < 10*180; i++)
    {
        ...
        input.mox_reading[0] = sensor_reading[i*100][0];
        input.mox_reading[1] = sensor_reading[i*100][1];
        input.mox_reading[2] = sensor_reading[i*100][2];

        for (int idx_s = 0; idx_s < 3; idx_s++)
            for (int idx_rd = 0; idx_rd < 100; idx_rd++)
                foc.data_interp[idx_s].push_back(sensor_reading[i*100+idx_rd][idx_s]);
